# 🌾 Akıllı Tarım & Zirai Hava

Open-Meteo ile toprak nemi/sıcaklığı derinlikleri, don riski erken uyarı sistemi, evapotranspirasyon ve sulama tavsiyeleri.
...
- **API Source:** OpenWeatherMap / Agricultural Data API
